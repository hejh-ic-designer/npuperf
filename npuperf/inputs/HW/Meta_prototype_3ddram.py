...
def memory_hierarchy_dut(multiplier_array):
    ...
    #######################################################################################################################
    dram_3d = MemoryInstance(name="3ddram_26GB", size=26 *1024 * 1024 *1024 * 8, r_bw=2048, w_bw=2048, r_cost=70, w_cost=75, area=0, bank=1,
                       random_bank_access=False, r_port=0, w_port=0, rw_port=1, latency=20)
    ...
    memory_hierarchy_graph.add_memory(memory_instance=dram_3d, operands=('I1','I2','O'),
