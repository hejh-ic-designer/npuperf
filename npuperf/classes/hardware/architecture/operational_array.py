...
import numpy as np
from npuperf.classes.hardware.architecture.dimension import Dimension
from npuperf.classes.hardware.architecture.operand_spatial_sharing import OperandSpatialSharing
from npuperf.classes.hardware.architecture.operational_unit import OperationalUnit, Multiplier
...
class OperationalArray:
    def __init__(self, operational_unit: OperationalUnit, dimensions: Dict[str, int]):
        ...
        self.nb_dimensions = len(base_dims)     # 一般至少2个，即D1 D2，多的有4个，即D1 ~ D4

    def __str__(self):
        return f"Operational_Array(dimensions={self.dimension_sizes})"
