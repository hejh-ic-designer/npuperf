...
from npuperf.classes.opt.spatial.generator import UserSpatialMappingGenerator
from npuperf.classes.stages.Stage import Stage
from npuperf.classes.stages.SpatialMappingConversionStage import SpatialMappingConversionStage
import copy
...
class SpatialMappingGeneratorStage(Stage):
    ...
    def run(self):
        ...
        for i, user_spatial_mapping in enumerate(user_spatial_mappings):
            ...
            ###===================
            if user_spatial_mapping in [{'D1': ('FY', 3), 'D2': ('FY', 3)}, {'D1': ('FX', 3), 'D2': ('FX', 3)}]:
                continue
            ###===================
