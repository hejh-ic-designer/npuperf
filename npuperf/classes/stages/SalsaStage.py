...
from npuperf.classes.opt.temporal.salsa.engine import SalsaEngine
...
class SalsaStage(Stage):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.opt_criterion_name = kwargs.get("salsa_opt_criterion", "latency")       # salsa_opt_criterion 默认为 latency
