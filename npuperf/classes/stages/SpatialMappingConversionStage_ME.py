...
class SpatialMappingConversionStage_ME(Stage):
    """
    ...
    def run(self):
        ...
        spatial_mapping = self.convert_user_spatial_mapping(user_spatial_mapping)   #= 将dict类型的user spatial mapping 转为spatial_mapping类的实例
    ...
    def convert_user_spatial_mapping(self, user_spatial_mapping):
        ...
        # logger.info(f"user provided spatial mapping is: {user_spatial_mapping}")
        ...
        for spatial_dim_name, spatial_loop in user_spatial_mapping.items():
            ...
            user_spatial_mapping[spatial_dim_name] = []
            ...
            for (loop_dim_unrolled, loop_size_unrolled) in spatial_loop:
                ...
                user_spatial_mapping[spatial_dim_name].append((loop_dim_unrolled, loop_size_unrolled))
        ...
        # logger.info(f"Convert user spatial mapping: {spatial_mapping_dict}")
        # logger.info("Convert spatial_mapping Finished.")
        return SpatialMapping(spatial_mapping_dict=spatial_mapping_dict,
                              layer_node=self.layer)

# workload里提供的spatial mapping:
...
#     'O': [
#         [('C', 1.5)],
#         [('K', 32.0), ('OY', 3.9166666666666665), ('OX', 3.9166666666666665)],
#         [],
#         []
#         ],

#     'W': [
#         [('OX', 3.9166666666666665), ('OY', 3.9166666666666665)],
#         [('K', 32.0), ('C', 1.5)],
#         [],
#         [],
#         []
...
#     'I': [
#         [('K', 32.0), ('C', 1.5), ('OY', 3.9166666666666665), ('OX', 3.9166666666666665)],
#         []
#         ]
